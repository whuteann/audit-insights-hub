...
export const DOCUMENT_SOURCE_PATH_GROUPS: SourcePathGroup[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Key Competitors", value: "key_competitors" },
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Is Loss Making", value: "is_loss_making" },
      { label: "Business Lines Other", value: "business_lines_other" },
      { label: "Products/Services Description", value: "products_services_desc" },
      { label: "Key Business Drivers", value: "key_business_drivers" },
      { label: "Supply Chain Description", value: "supply_chain_desc" },
      { label: "Industry/Regulatory/Economic", value: "industry_regulatory_economic" },
      { label: "Restructuring Occurred", value: "restructuring_occurred" },
      { label: "Restructuring Details", value: "restructuring_details" },
      { label: "IP Owner Entity", value: "ip_owner_entity" },
      { label: "Intangible Agreements Exist", value: "intangible_agreements_exist" },
      { label: "Intangible Transfer During FY", value: "intangible_transfer_during_fy" },
      { label: "Funding Third Party %", value: "funding_third_party_pct" },
      { label: "Funding Intercompany %", value: "funding_intercompany_pct" },
      { label: "Funding Equity %", value: "funding_equity_pct" },
      { label: "Local Company Overview", value: "local_company_overview" },
      { label: "Local Business Model", value: "local_business_model" },
      { label: "Local Business Strategy Choice", value: "local_business_strategy_choice" },
      { label: "Local Business Strategy Description", value: "local_business_strategy_desc" },
      { label: "Consolidated Group Revenue", value: "consolidated_group_revenue" },
      { label: "Local Profit Before Tax", value: "local_profit_before_tax" },
      { label: "APA Exists", value: "apa_exists" },
    ],
  },
  {
